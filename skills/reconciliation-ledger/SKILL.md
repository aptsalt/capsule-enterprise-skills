...
The current version `1.0.0` was promoted by the RL gate from capsule **CAP-1004**
...
Each reuse of this skill saves **700 tokens** versus re-deriving the pattern
from a cold session (measured in the A/B harness).

## Pull this skill

```bash
capsule pull reconciliation-ledger@1.0.0        # pin this exact version
